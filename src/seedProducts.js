...
const productsDao = mongoose.model('seedProducts',productsSchema)

await mongoose.connect('mongodb+srv://sannnty50:Mika14561@tiendaiphone.cpcjnks.mongodb.net/productos?retryWrites=true&w=majority',{
    serverSelectionTimeoutMS:5000,
})

console.log ('Base de datos conectada...')

await productsDao.insertMany(seedProducts)
